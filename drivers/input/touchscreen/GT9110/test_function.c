...
0x32,0x05,0x5A,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x18,0x1A,0x1E,0x14,0x95,0x35,0xFF,\
0x60,0x62,0xD9,0x0B,0x00,0x00,0x00,0x00,0x03,0x2C,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x1B,0x46,0x94,0x40,0x02,0x00,0x00,0x00,0x04,\
0x9A,0x1D,0x00,0x7C,0x24,0x00,0x65,0x2B,0x00,0x52,\
0x34,0x00,0x45,0x3F,0x00,0x45,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
...
0x03,0x02,0x01,0x00,0x19,0x01\
};
const u8 module_cfg2[]={\
0x41,0x20,0x03,0x00,0x05,0x0A,0x0C,0x00,0x01,0x08,\
0x32,0x05,0x5A,0x32,0x03,0x05,0x00,0x00,0x00,0x00,\
0x00,0x00,0x00,0x18,0x1A,0x1E,0x14,0x95,0x35,0xFF,\
0x64,0x66,0xD9,0x0B,0x00,0x00,0x00,0x00,0x03,0x2C,\
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,\
0x00,0x1B,0x46,0x94,0x40,0x02,0x00,0x00,0x00,0x04,\
0x9A,0x1D,0x00,0x7C,0x24,0x00,0x65,0x2B,0x00,0x52,\
0x34,0x00,0x45,0x3F,0x00,0x45,0x00,0x00,0x00,0x00,\
 ...
 s32 Save_testing_data(char *save_test_data_dir, int test_types,u16 *current_rawdata_temp)
{
	...
	sprintf((char *)itosavepath, "/sdcard/ITO_Test_Data_%02d.csv",ITO_TEST_COUNT);
	//fp = fopen("/sdcard/ITO_Test_Data.csv", "a+");
	...
	if ((test_types & _ACCORD_CHECK) != 0) {
		...
		for (i = 0; i < GT_Sennum; i++) {
			...
			for (j = 0; j < GT_Drvnum; j++) {
				...
				bytes += (s32) sprintf((char *)&data[bytes], "%d,", (accord_limit_min[i + j * GT_Sennum]));
