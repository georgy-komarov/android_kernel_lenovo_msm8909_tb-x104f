		...
		struct platform_device *pdev, char *panel_cfg)
{
	...
	if (!len) {
		...
		//add by 101003082 for lcd INFO at 2018/04/11 begin
		if(!strcmp(panel_name, "qcom,mdss_dsi_jd9365_starry_video")){
			hq_regiser_hw_info(HWID_LCM,"JD9365_STARRY_VIDEO");
		}else if(!strcmp(panel_name, "qcom,mdss_dsi_nt35521z_inx101_video")){
			hq_regiser_hw_info(HWID_LCM,"NT35521Z_INX101_VIDEO");
		}
		//add by 101003082 for lcd INFO at 2018/04/11 end
